            ...
            for client in clients:
                if client != client_socket:
                    try:
                        ...
                        clients.remove(client) # This part seems to be an isolated 'except' block, likely from a previous 'try'
                                   # block in the `client_handle` function.

    except: # This 'except' block seems to be closing the try block started earlier in client_handle
